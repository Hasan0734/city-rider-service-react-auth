        ...
        <div className="row mt-3">
          <div className="col-12 col-sm-4 my-4 my-sm-0">
            <div className="card">
              ...
              <h5>Pick Form</h5> 
                <input className="input-from" {...register("pickForm", { required: true, pattern: /^[A-Za-z]+$/i  })} placeholder="Type here.." />
                {errors.pickForm && <span className="error">This field is required</span>}
                <h5>Pick To</h5>          
                <input className="input-from" {...register("pickTo", { required: true, pattern: /^[A-Za-z]+$/i })} placeholder="Type here.."/> 
